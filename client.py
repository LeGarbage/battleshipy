    ...
    try:
        ...
        while True:
            ...
            if my_turn:
                ...
                # Receive the opponent's move (blocks until data arrives)
                move = client.recv(1024).decode()
                if not move:  # Connection lost
                    break
                
                # Process the move and send back the result
                result = game.handle_opponent_move(move)
